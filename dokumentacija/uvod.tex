...
\begin{itemize}
    ...
    \item \textbf{HTML, CSS i JavaScript}: Za izradu skica korisničkog interfejsa.
    \item \textbf{OBS (Open Broadcaster Software)}: Za snimanje video zapisa korišćenja sistema.
\end{itemize}