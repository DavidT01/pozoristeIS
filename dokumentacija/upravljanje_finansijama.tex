...
\end{enumerate}
Koraci 1-6 se ponavljaju dok finansijski službenik ne odluči da izađe iz podtoka klikom na dugme "Nazad", čime se slučaj vraća na korak 2 osnovnog toka.
...
\begin{itemize}
    \item Ako u koraku 3 podtoka P2 finansijski službenik unese iznos koji prelazi dozvoljeni limit izmene plate, sistem prikazuje upozorenje: ''Povišica prelazi dozvoljeni limit.'' Slučaj se vraća na korak 3 podtoka P2.
\end{itemize}

\textbf{A3: Greška na štampaču}
\begin{itemize}
    \item Ako u koraku 4 podtoka P5 dođe do greške prilikom komunikacije sa štampačem, sistem prikazuje poruku o grešci i slučaj se vraća na korak 1 podtoka P5.
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{./Dijagrami/Dijagram slučajeva upotrebe/upravljanje_finansijama.png} 
    \caption{Dijagram slučaja upotrebe "Upravljanje finansijama"}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth, height=0.95\textheight, keepaspectratio]{./Dijagrami/Dijagram sekvence/upravljanje_finansijama.png} 
    \caption{Dijagram sekvence "Upravljanje finansijama"}
\end{figure}
