...
\begin{enumerate}
    ...
    \item Gledalac bira sedište.
    \item Blagajnik potvrđuje izbor.
    \item Sistem prikazuje ukupan iznos i opcije plaćanja.
    \item Blagajnik pita Gledalac da li mu treba gotovinski račun:
    \begin{itemize}
...
\textbf{A1: Nema dostupnih karata}
 \begin{itemize}
 \item Sistem obaveštava gledaoca da nema dostupnih karata za izabranu predstavu u izabranom terminu i Gledalac  traži novi termin slučaj se vraća na korak 4.
\end{itemize}
