...
\textbf{Komponente:}
\begin{itemize}
    \item \textbf{Veb aplikacija za gledaoce:} Online prodaja karata (izbor predstave, sedišta, plaćanje). Koristi responsive dizajn za desktop i mobilne uređaje.
...
\textbf{Tehnologije:} React.js/Vue.js za veb, Flutter/React Native za mobilno. API pozivi ka backend-u.
