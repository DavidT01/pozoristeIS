...
\begin{figure}[h!]
	\centering
	\includegraphics[width=\textwidth]{./Slučajevi upotrebe/azuriranje_informacija_o_predstavi.png} 
	\caption{Dijagram slučaja upotrebe "azuriranje informacija o predstavi"}
\end{figure}
